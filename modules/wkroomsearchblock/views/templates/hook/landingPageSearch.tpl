                            ...
                            <form method="POST" id="search_hotel_block_form">
                                {if isset($location_enabled) && $location_enabled}
                                    ...
                                    {else}
                                        col-sm-6 col-lg-3
                                    {/if}">
                                        <input type="text" class="form-control header-rmsearch-input" id="hotel_location" name="hotel_location" autocomplete="off" placeholder="{l s='Hotel Location1' mod='wkroomsearchblock'}">
                                        <div class="dropdown">
                                ...
                                {/if}">
                                   <button type="submit" class="btn btn-default button button-medium exclusive" name="search_room_submit" id="search_room_submit">
                                     ...
                                     <button type="submit" class="btn btn-default button button-medium exclusive" name="search_hotel_submit" id="search_hotel_submit">
                                        <span>{l s='Search Hotels' mod='wkroomsearchblock'}</span>
                                    </button>
                                </div>
