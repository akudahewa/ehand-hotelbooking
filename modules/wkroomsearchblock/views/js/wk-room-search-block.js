...
$(document).ready(function() {
    ...
    // $('#search_room_submit').on('click', function(e) {
        // $('button[name="search_room_submit"]')
        $(document).on('click', 'button[name="search_room_submit"]', function(e) {
            alert("aaaaaaaaa "+this.name)
    ...
    $(document).on('click', '#search_hotel_submit', function(e) {
       // alert("sssss111")
        e.preventDefault();
       // $('#hotel_location').attr('value', $(this).html());
        // $('#hotel_location').attr('city_cat_id', $(this).val());
        //alert($('#hotel_location').attr('city_cat_id'))
      //  $('.location_search_results_ul').empty().hide();
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                if (result.status == 'success') {
                    //$('#hotel_cat_id').val('');
                    //$('#hotel_cat_name').html('Select Hotel')id;
                    //$('.hotel_dropdown_ul').empty();
                     $('.hotel_list').html(result.hotel);
                    // $('#hotel_location').attr('value', result.data);
                } else {
                    alert(no_results_found_cond);
                }
            }
