<?php /* Smarty version Smarty-3.1.19, created on 2021-03-04 09:43:08
         compiled from "/var/www/html/hotelcommerce/modules/wkroomsearchblock/views/templates/hook/landingPageSearch.tpl" */ ?>
<?php /*%%SmartyHeaderCode:150982612460405e5472d194-63099178%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6f46becb8868431c60f2e2c8b7153690f80e75c8' => 
    array (
      0 => '/var/www/html/hotelcommerce/modules/wkroomsearchblock/views/templates/hook/landingPageSearch.tpl',
      1 => 1614831144,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '150982612460405e5472d194-63099178',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60405e547617f7_75469197',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60405e547617f7_75469197')) {function content_60405e547617f7_75469197($_smarty_tpl) {?>
                            ...
                            <form method="POST" id="search_hotel_block_form">
                                <?php if (isset($_smarty_tpl->tpl_vars['location_enabled']->value)&&$_smarty_tpl->tpl_vars['location_enabled']->value) {?>
                                    ...
                                    <?php } else { ?>
                                        col-sm-6 col-lg-3
                                    <?php }?>">
                                        <input type="text" class="form-control header-rmsearch-input" id="hotel_location" name="hotel_location" autocomplete="off" placeholder="<?php echo smartyTranslate(array('s'=>'Hotel Location1','mod'=>'wkroomsearchblock'),$_smarty_tpl);?>
">
                                        <div class="dropdown">
...
">
                                ...
                                <?php }?>">
                                   <button type="submit" class="btn btn-default button button-medium exclusive" name="search_room_submit" id="search_room_submit">
                                     ...
                                     <button type="submit" class="btn btn-default button button-medium exclusive" name="search_hotel_submit" id="search_hotel_submit">
                                        <span><?php echo smartyTranslate(array('s'=>'Search Hotels','mod'=>'wkroomsearchblock'),$_smarty_tpl);?>
</span>
                                    </button>
                                </div>
